...
class VwApproverAddForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $table = NULL) {
    ...
    // Set the table name.
    $form_state->set('osha_workflow_table', $table);
    ...
    $users = $this->getUsers($form_state->get('osha_workflow_list_configuration')['access_roles']);
    $form['user_id'] = [
      '#type' => 'select',
  ...
  public function weightCallback(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($table as $row) {
      ...
      $this->helper->setUserWeight($form_state->get('osha_workflow_table'), $data);
    }
  }
  ...
  public function removeCallback(array &$form, FormStateInterface $form_state) {
    ...
    $this->helper->deleteUserToList($form_state->get('osha_workflow_table'), $data);
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($this->helper->checkUserExists($form_state->get('osha_workflow_table'), $user_id)) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $weight = 0;
    $previous_user = $this->helper->getLastUserList($form_state->get('osha_workflow_table'));
    ...
    $this->helper->addUserToList($form_state->get('osha_workflow_table'), $fields);
  }
